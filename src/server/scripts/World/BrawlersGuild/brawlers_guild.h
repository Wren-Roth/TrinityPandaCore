...
const std::map<uint32, uint32> reputationEncounterType =
{
    ...
    { 1001, ACTION_DIPPY           },
    { 1251, ACTION_KIRRAWK         },
    { 1501, ACTION_FRAN_AND_RIDDOH },
    { 1751, ACTION_KING_KULAKA     },
    { 2001, ACTION_BLAT            },
    { 2251, ACTION_SANORIAK        },
    { 2501, ACTION_IXX             },
    { 2751, ACTION_MAZHAREEN       },
    { 3001, ACTION_CRUSH           },
    { 3251, ACTION_LEONA           },
    { 3501, ACTION_DOMINIKA        },
    { 3751, ACTION_DEEKEN          },
    { 4001, ACTION_MILLIE_WATT     },
    { 4251, ACTION_FJOLL           },
    { 4501, ACTION_PROBOSKUS       },
    { 4751, ACTION_LEPREGNOMES     },
    { 5001, ACTION_YIKKAN_IZU      },
    { 5251, ACTION_AKAMA           },
    { 5501, ACTION_HOOFSTOMP       },
    { 5751, ACTION_UNGULOXX        },
    { 6001, ACTION_GG_INGENEERING  },
    { 6251, ACTION_DARK_SUMMONER   },
    { 6501, ACTION_BATTLETRON      },
    { 6751, ACTION_MEATBALL        },
};
